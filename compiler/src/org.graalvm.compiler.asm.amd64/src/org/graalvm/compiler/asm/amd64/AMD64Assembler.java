...
public class AMD64Assembler extends AMD64BaseAssembler {
    ...
    public final void vmovupd(Register dst, Register src) {
        assert supports(CPUFeature.AVX512F);
        // Code: EVEX.512.66.0F.W1 10 /r
        evexPrefix(dst, Register.None, Register.None, src, AVXSize.ZMM, P_66, M_0F, W1, Z0, B0);
        emitByte(0x10);
        emitModRM(dst, src);
    }

    // _mm512_loadu_pd
    public final void vmovupd(Register dst, AMD64Address src) {
        assert supports(CPUFeature.AVX512F);
        // Code: EVEX.512.66.0F.W1 10 /r
        evexPrefix(dst, Register.None, Register.None, src, AVXSize.ZMM, P_66, M_0F, W1, Z0, B0);
        emitByte(0x10);
    ...
    // _mm512_storeu_pd
    public final void vmovupd(AMD64Address dst, Register src) {
        assert supports(CPUFeature.AVX512F);
        // Code: EVEX.512.66.0F.W1 10 /r
        evexPrefix(src, Register.None, Register.None, dst, AVXSize.ZMM, P_66, M_0F, W1, Z0, B0);
        emitByte(0x11);
        emitOperandHelper(src, dst, 0, EVEXTuple.FVM.getDisp8ScalingFactor(AVXSize.ZMM));
    }
    ...
    */
    ...
    // _mm512_add_pd
    public final void vaddpd(Register dst, Register a, AMD64Address b) {
        assert supports(CPUFeature.AVX512F);
    ...
    // _mm512_add_pd with mask (Z0 so that values in dst are unchanged if mask is 0)
    ...
    // _vfmadd231pd (Multiply a and b, add dst and store result in dst)
    public final void vfmadd231pd(Register dst, Register a, Register b) {
        assert supports(CPUFeature.AVX512F);
    ...
    // _mm512_mask_mov_pd
    public final void vmovapd(Register dst, Register src) {
        assert supports(CPUFeature.AVX512F);
        // Code: EVEX.512.66.0F.W1 28 /r
        evexPrefix(dst, Register.None, Register.None, src, AVXSize.ZMM, P_66, M_0F, W1, Z0, B0);
        emitByte(0x28);
        emitModRM(dst, src);
    }
    ...
    // vpbroadcastq
    public final void vpbroadcastq(Register dst, Register src) {
        assert supports(CPUFeature.AVX512F);
        // Code: EVEX.512.66.0F38.W1 7C /r
    ...
    // vbroadcastsd
    public final void vbroadcastsd(Register dst, Register src) {
        assert supports(CPUFeature.AVX512F);
    ...
    public final void vpxorq(Register dst, Register a, Register b) {
        assert supports(CPUFeature.AVX512F);
        // Code: EVEX.512.66.0F.W1 EF /r
        evexPrefix(dst, Register.None, a, b, AVXSize.ZMM, P_66, M_0F, W1, Z0, B0);
        emitByte(0xEF);
